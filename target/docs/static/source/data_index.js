indexData = [
  ...
  ["valor absoluto, módulo, abs()","lib/Math.htm#Abs"],
  ["Agradecimentos","misc/Acknowledgements.htm"],
  ["ACos (Transform)","lib/Transform.htm#ACos",7],
  ["ACos()","lib/Math.htm#ACos",2],
  ["ativar uma janela","lib/WinActivate.htm"],
  ["controles do ActiveX (GUI)","lib/GuiControls.htm#ActiveX"],
  ["adição","lib/EnvAdd.htm"],
  ...
  ["acrescentar a um arquivo","lib/FileAppend.htm"],
  ...
  ["atributos de arquivos e pastas","lib/FileGetAttrib.htm"],
  ...
  ["Balão de aviso","lib/TrayTip.htm"],
  ...
  ["soar o autofalante do PC","lib/SoundBeep.htm"],
  ["between (checar se a variável está entre dois valores)","lib/IfBetween.htm"],
  ...
  ["Send em modo blind","lib/Send.htm#blind"],
  ["BlockInput","lib/BlockInput.htm",6,"S"],
  ["blocos (linhas envoltas por chaves)","lib/Block.htm"],
  ["boolean (concepts)","Concepts.htm#boolean"],
  ["Bottom (WinSet)","lib/WinSet.htm#Bottom",7],
  ["Objeto atrelado à função (Func.Bind)","misc/Functor.htm#BoundFunc"],
  ...
  ["Controles de checkbox (GUI)","lib/GuiControls.htm#Checkbox"],
  ["Checked (ControlGet)","lib/ControlGet.htm#Checked",7],
  ["Choice (ControlGet)","lib/ControlGet.htm#Choice",7],
  ["selecionar um arquivo","lib/FileSelectFile.htm"],
  ["selecionar uma pasta","lib/FileSelectFolder.htm"],
  ...
  ["Clicar um botão do mouse","lib/Click.htm"],
  ...
  ["fechar uma janela","lib/WinClose.htm"],
  ...
  ["Menu de contexto (GUI)","lib/Gui.htm#GuiContextMenu"],
  ...
  ["coordenadas","lib/CoordMode.htm"],
  ["CoordMode","lib/CoordMode.htm",6,"SS"],
  ["copiar arquivo","lib/FileCopy.htm"],
  ["copiar pasta/diretório","lib/FileCopyDir.htm"],
  ...
  ["Criar um arquivo","lib/FileAppend.htm"],
  ["criar uma pasta/diretório","lib/FileCreateDir.htm"],
  ["Critical","lib/Critical.htm",6,"S"],
  ["diretório atual","lib/SetWorkingDir.htm"],
  ...
  ["Controles personalizados (GUI)","lib/GuiControls.htm#Custom"],
  ["datas e horários (comparar)","lib/EnvSub.htm"],
  ["datas e horários (operações matemáticas)","lib/EnvAdd.htm"],
  ["datas e horários (de arquivos)","lib/FileSetTime.htm"],
  ["Controles DateTime (GUI)","lib/GuiControls.htm#DateTime"],
  ["Diretiva de depuração (Ahk2Exe)","misc/Ahk2ExeDirectives.htm#Debug",99],
  ["depurador","lib/OutputDebug.htm"],
  ["depurando um script","Scripts.htm#debug"],
  ["casas decimais","lib/Format.htm"],
  ["Default (Gui)","lib/Gui.htm#Default",7],
  ["Default (Menu)","lib/Menu.htm#Default",7],
  ["Default","lib/Switch.htm",3,""],
  ["excluir arquivos","lib/FileDelete.htm"],
  ["excluir uma pasta/diretório","lib/FileRemoveDir.htm"],
  ...
  ["caixa de diálogo FileSelectFile","lib/FileSelectFile.htm"],
  ["caixa de diálogo FileSelectFolder","lib/FileSelectFolder.htm"],
  ["caixa de diálogo InputBox","lib/InputBox.htm"],
  ["caixa de diálogo MsgBox","lib/MsgBox.htm"],
  ["digit","lib/IfIs.htm"],
  ...
  ["espaço em disco","lib/DriveSpaceFree.htm"],
  ...
  ["baixar um arquivo","lib/URLDownloadToFile.htm"],
  ["DPI scaling","misc/DPIScaling.htm"],
  ["arrastar-e-soltar (janelas de GUI)","lib/Gui.htm#GuiDropFiles"],
  ["arrastar o mouse","lib/MouseClickDrag.htm"],
  ["Drive","lib/Drive.htm",6,"SSS"],
  ["DriveGet","lib/DriveGet.htm",6,"OSS"],
  ["DriveSpaceFree","lib/DriveSpaceFree.htm",6,"OS"],
  ["controles DropDownList (GUI)","lib/GuiControls.htm#DropDownList"],
  ["chamadas dinâmicas de função","Functions.htm#DynCall"],
  ["variáveis dinâmicas","Language.htm#dynamic-variables"],
  ["Edit","lib/Edit.htm",6,""],
  ["controles Edit (GUI)","lib/GuiControls.htm#Edit"],
  ...
  ["Objeto enumerador","lib/Enumerator.htm"],
  ...
  ["variáveis de ambiente (alterá-las)","lib/EnvSet.htm"],
  ...
  ["atributos de arquivos","lib/FileSetAttrib.htm"],
  ["objeto arquivo","lib/File.htm"],
  ["arquivo ou pasta (determinar se existe)","lib/IfExist.htm"],
  ["padrão de caminho de arquivo","lib/LoopFile.htm"],
  ["File property (Exception)","lib/Throw.htm#Exception",8],
  ["arquivo, criar","lib/FileAppend.htm"],
  ["arquivo, ler","lib/LoopReadFile.htm"],
  ["arquivo, gravar/acrescentar","lib/FileAppend.htm"],
  ...
  ["encontrar um arquivo","lib/IfExist.htm"],
  ["encontrar uma string","lib/StringGetPos.htm"],
  ["encontrar uma janela","lib/WinExist.htm"],
  ...
  ["ponto flutuante (verificar se se trata de um)","lib/IfIs.htm"],
  ["ponto flutuante (Format)","lib/Format.htm"],
  ...
  ["foco","lib/ControlFocus.htm"],
  ["FocusV (GuiControlGet)","lib/GuiControlGet.htm#FocusV",7],
  ["copiar pasta/diretório","lib/FileCopyDir.htm"],
  ["criar pasta/diretório","lib/FileCreateDir.htm"],
  ["mover pasta/diretório","lib/FileMoveDir.htm"],
  ["excluir pasta/diretório","lib/FileRemoveDir.htm"],
  ["selecionar pasta/diretório","lib/FileSelectFolder.htm"],
  ...
  ["formatar (padrões)","lib/Format.htm"],
  ["FormatTime","lib/FormatTime.htm",6,"OSS"],
  ["espaço livre","lib/DriveSpaceFree.htm"],
  ["exemplo de upload via FTP","lib/FileAppend.htm#FTP"],
  ["functions (concepts)","Concepts.htm#functions"],
  ["funções (definindo e chamando)","Functions.htm"],
  ["funções (bibliotecas)","Functions.htm#lib"],
  ["Objetos de Função","misc/Functor.htm"],
  ["Func","lib/Func.htm"],
  ["Func()","lib/Func.htm#Func",2],
  ["g-label (respondendo a eventos de GUIs)","lib/Gui.htm#label"],
  ["automação de jogos","lib/PixelSearch.htm"],
  ...
  ["formato hexadecimal","lib/Format.htm"],
  ["hibernar ou suspender","lib/Shutdown.htm#Suspend"],
  ["HICON:","misc/ImageHandles.htm"],
  ["texto oculto","lib/DetectHiddenText.htm"],
  ["janelas ocultas","lib/DetectHiddenWindows.htm"],
  ...
  ["gancho","lib/_InstallKeybdHook.htm"],
  ["Hotkeys (informações gerais)","Hotkeys.htm"],
  ["Hotkey","lib/Hotkey.htm",6,"SSS"],
  ["controles de Hotkeys (GUI)","lib/GuiControls.htm#Hotkey"],
  ...
  ["nomes das cores no HTML","lib/Progress.htm#colors"],
  ...
  ["ícone, alterar","lib/Menu.htm#Icon"],
  ["número ID de uma janela","lib/WinGet.htm"],
  ...
  ["If (forma legada)","lib/IfEqual.htm"],
  ...
  ["Listas de Imagens (GUI)","lib/ListView.htm#IL"],
  ...
  ["inteiro (checar se se trata de um)","lib/IfIs.htm"],
  ["inteiro (Formato)","lib/Format.htm"],
  ...
  ["comprimento de uma string","lib/StrLen.htm"],
  ...
  ["Controles de link (GUI)","lib/GuiControls.htm#Link"],
  ...
  ["Controles de caixa de listagem (GUI)","lib/GuiControls.htm#ListBox"],
  ["ListHotkeys","lib/ListHotkeys.htm",6,""],
  ["ListLines","lib/ListLines.htm",6,"S"],
  ["ListVars","lib/ListVars.htm",6,""],
  ["Controles de visualização de lista (ListView) (GUI)","lib/ListView.htm"],
  ["Visualização de lista, obter texto de","lib/ControlGet.htm#List"],
  ["Ln (Transform)","lib/Transform.htm#Ln",7],
  ["Ln()","lib/Math.htm#Ln",2],
  ["arquivo lnk (atalho/link)","lib/FileCreateShortcut.htm"],
  ["LoadPicture()","lib/LoadPicture.htm",2],
  ["local","Functions.htm#Local",5],
  ["variáveis locais","Functions.htm#Local"],
  ["Localização geográfica","lib/StringCaseSense.htm#Locale"],
  ["Lock (Drive)","lib/Drive.htm#Lock",7],
  ["Log (Transform)","lib/Transform.htm#Log",7],
  ["Log()","lib/Math.htm#Log",2],
  ["logaritmo, log()","lib/Math.htm#Log"],
  ["logoff","lib/Shutdown.htm"],
  ["nome longo de arquivo (converter para)","lib/LoopFile.htm#LoopFileLongPath"],
  ...
  ["funções matemáticas","lib/Math.htm"],
  ...
  ["Barra de Menu (GUI)","lib/Gui.htm#Menu"],
  ["Ícone de Menu","lib/Menu.htm#MenuIcon"],
  ["lista de mensagens (WM_*)","misc/SendMessageList.htm"],
  ["Message property (Exception)","lib/Throw.htm#Exception",8],
  ["mensagens, receber","lib/OnMessage.htm"],
  ["mensagens, enviar","lib/PostMessage.htm"],
  ...
  ["modal (sempre no topo)","lib/MsgBox.htm"],
  ["resto de uma divisão, mod()","lib/Math.htm#Mod"],
  ...
  ["Controles de MonthCal (GUI)","lib/GuiControls.htm#MonthCal"],
  ["gancho de mouse","lib/_InstallMouseHook.htm"],
  ["velocidade do mouse","lib/SetDefaultMouseSpeed.htm"],
  ["roda do mouse","lib/Click.htm"],
  ...
  ["mover uma janela","lib/WinMove.htm"],
  ["mover um arquivo","lib/FileMove.htm"],
  ["mover uma pasta/diretório","lib/FileMoveDir.htm"],
  ["Move (GuiControl)","lib/GuiControl.htm#Move",7],
  ["MoveDraw (GuiControl)","lib/GuiControl.htm#MoveDraw",7],
  ["MsgBox","lib/MsgBox.htm",6,"SSSS"],
  ["multiplicar","lib/EnvMult.htm"],
  ["mutar (alterar)","lib/SoundSet.htm"],
  ...
  ["Funções e métodos de objetos","lib/Object.htm"],
  ...
  ["abrir arquivo","lib/FileOpen.htm"],
  ...
  ["Proprietário de uma janela de GUI","lib/Gui.htm#Owner"],
  ["parâmetros passados para um script","Scripts.htm#cmd"],
  ["analisar uma string (Loop)","lib/LoopParse.htm"],
  ["analisar uma string (StrSplit)","lib/StrSplit.htm"],
  ["Pause","lib/Pause.htm",6,"SS"],
  ["desempenho de scripts","misc/Performance.htm"],
  ["Controles de imagens (GUI)","lib/GuiControls.htm#Picture"],
  ...
  ["reproduzir um arquivo de som ou vídeo","lib/SoundPlay.htm"],
  ...
  ["imprimir um arquivo","lib/Run.htm"],
  ...
  ["Controles de progresso (GUI)","lib/GuiControls.htm#Progress"],
  ["propriedades (Objetos)","Objects.htm#Custom_Classes_property"],
  ["propriedades de um arquivo ou pasta","lib/Run.htm"],
  ["Push method (Object)","lib/Object.htm#Push",8],
  ["sair de um script","lib/ExitApp.htm"],
  ["Controles de botões de seleção (GUI)","lib/GuiControls.htm#Radio"],
  ["Random","lib/Random.htm",6,"OEE"],
  ["Send, em modo bruto (raw)","lib/Send.htm#SendRaw"],
  ["RawRead method (File)","lib/File.htm#RawRead",8],
  ["RawWrite method (File)","lib/File.htm#RawWrite",8],
  ["ler um arquivo","lib/FileRead.htm"],
  ...
  ["reiniciar o computador","lib/Shutdown.htm"],
  ...
  ["RegExes: SetTitleMatchMode RegEx","lib/SetTitleMatchMode.htm#RegEx"],
  ...
  ["loop no registro","lib/LoopReg.htm"],
  ...
  ["expressões regulares: RegExMatch()","lib/RegExMatch.htm"],
  ["expressões regulares: RegExReplace()","lib/RegExReplace.htm"],
  ["expressões regulares: SetTitleMatchMode RegEx","lib/SetTitleMatchMode.htm#RegEx"],
  ...
  ["renomear um arquivo","lib/FileMove.htm"],
  ["Rename (Menu)","lib/Menu.htm#Rename",7],
  ["redimensionar uma janela","lib/WinMove.htm"],
  ["reiniciar o computador","lib/Shutdown.htm"],
  ["Restore (Gui)","lib/Gui.htm#Restore",7],
  ["Return","lib/Return.htm",3,"E"],
  ["Nomes das cores RGB","lib/Progress.htm#colors"],
  ["Cores RGB","lib/PixelGetColor.htm"],
  ["Round (Transform)","lib/Transform.htm#Round",7],
  ["Round()","lib/Math.htm#Round",2],
  ["arredondar um número","lib/Math.htm#Round"],
  ...
  ["nome curto de arquivo (formato 8.3)","lib/LoopFile.htm#LoopFileShortPath"],
  ["avaliação booleana em curto-circuito","Functions.htm#ShortCircuit"],
  ["arquivo de atalho","lib/FileCreateShortcut.htm"],
  ...
  ["tamanho de um arquivo/pasta","lib/FileGetSize.htm"],
  ["tamanho de uma janela","lib/WinGetPos.htm"],
  ["Sleep","lib/Sleep.htm",6,"E"],
  ["Controles de Slider (GUI)","lib/GuiControls.htm#Slider"],
  ...
  ["space","lib/IfIs.htm"],
  ["velocidade de um script","lib/SetBatchLines.htm"],
  ["Controle spinner (GUI)","lib/GuiControls.htm#UpDown"],
  ...
  ["saída padrão (stdout)","lib/FileAppend.htm"],
  ...
  ["Controles da barra de status (GUI)","lib/GuiControls.htm#StatusBar"],
  ...
  ["string (buscar uma)","lib/InStr.htm"],
  ...
  ["estruturas, via DllCall","lib/DllCall.htm#struct"],
  ...
  ["subtrair","lib/EnvSub.htm"],
  ["Variáveis supraglobais","Functions.htm#SuperGlobal"],
  ["Suspend","lib/Suspend.htm",6,"S"],
  ["suspender ou hibernar o computador","lib/Shutdown.htm#Suspend"],
  ["Switch","lib/Switch.htm",3,"E"],
  ["SysGet","lib/SysGet.htm",6,"OSSS"],
  ["Controles de várias abas (GUI)","lib/GuiControls.htm#Tab"],
  ...
  ["finalizar uma janela","lib/WinKill.htm"],
  ["finalizar o script","lib/ExitApp.htm"],
  ["operador ternário (?:)","Variables.htm#ternary"],
  ["Controles de texto (GUI)","lib/GuiControls.htm#Text"],
  ["Text (GuiControl)","lib/GuiControl.htm#Text",7],
  ["Send, em modo texto","lib/Send.htm#SendText"],
  ["Thread","lib/Thread.htm",6,"SEE"],
  ["fios de execução","misc/Threads.htm"],
  ["Throw","lib/Throw.htm",3,"E"],
  ["time (tipo de dados)","lib/IfIs.htm"],
  ["Timeout property (InputHook)","lib/InputHook.htm#Timeout",8],
  ["Timer (sub-rotinas baseadas em tempo)","lib/SetTimer.htm"],
  ["horários e datas (comparar)","lib/EnvSub.htm"],
  ["horários e datas (operações matemáticas)","lib/EnvAdd.htm"],
  ["horários e datas (de arquivos)","lib/FileSetTime.htm"],
  ["Tip (Menu)","lib/Menu.htm#Tip",7],
  ["título de uma janela","lib/WinSetTitle.htm"],
  ...
  ["transparência de uma janela","lib/WinSet.htm#trans"],
  ...
  ["menu da área de notificação (personalizar)","lib/Menu.htm"],
  ["TrayTip","lib/TrayTip.htm",6,"SSEE"],
  ["Controles de visualização em árvore de blocos (GUI)","lib/TreeView.htm"],
  ...
  ["Texto Unicode e área de transferência","lib/Transform.htm"],
  ...
  ["Controles de setas de incremento/diminuição (GUI)","lib/GuiControls.htm#UpDown"],
  ["URLDownloadToFile","lib/URLDownloadToFile.htm",6,"SS"],
  ["UseErrorLevel (Menu)","lib/Menu.htm#UseErrorLevel",7],
  ["UseHook","lib/_UseHook.htm"],
  ["usuário (executar como um usuário diferente)","lib/RunAs.htm"],
  ...
  ["Variáveis, atribuindo valores a","lib/SetEnv.htm"],
  ["Variáveis, nativas","Variables.htm#BuiltIn"],
  ["variáveis, compará-las","lib/IfEqual.htm"],
  ["variáveis, ListVars","lib/ListVars.htm"],
  ["variáveis, tipo de dados","lib/IfIs.htm"],
  ["Funções variádicas","Functions.htm#Variadic"],
  ["variantes (hotkeys e hotstrings duplicadas)","lib/_IfWinActive.htm#variant"],
  ["VarSetCapacity()","lib/VarSetCapacity.htm",2],
  ["VerCompare()","lib/VerCompare.htm",2],
  ["versão de um arquivo","lib/FileGetVersion.htm"],
  ["tecla virtual","lib/Send.htm#vk"],
  ...
  ["volume (aumentar/diminuir)","lib/SoundSet.htm"],
  ["esperar (sleep)","lib/Sleep.htm"],
  ["aguardar pelo pressionamento ou soltura de uma tecla","lib/KeyWait.htm"],
  ...
  ["Roda, simular rotação","lib/Click.htm"],
  ["While","lib/While.htm",3,"E"],
  ["espaço em branco","lib/AutoTrim.htm"],
  ["curingas (para arquivos e pastas)","lib/LoopFile.htm"],
  ...
  ["diretório de trabalho","lib/SetWorkingDir.htm"],
  ["wParam","lib/PostMessage.htm"],
  ["adicionar texto a um arquivo","lib/FileAppend.htm"],
