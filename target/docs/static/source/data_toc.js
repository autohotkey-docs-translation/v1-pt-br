tocData = [
  ...
  ["Índice de Comandos e Funções","lib/index.htm"],
  ["Ambiente","",
  [
  ...
  [
    ...
    ["Loop (arquivos e pastas)","lib/LoopFile.htm"],
    ["Loop (ler conteúdo de um arquivo)","lib/LoopReadFile.htm"],
  ...
  [
    ...
    [
      ["If (tradicional)","lib/IfEqual.htm"],
      ["If (expressão)","lib/IfExpression.htm"],
    ...
    [
      ["Loop","lib/Loop.htm"],
      ["Loop (arquivos e pastas)","lib/LoopFile.htm"],
      ["Loop (analisar uma string)","lib/LoopParse.htm"],
      ["Loop (ler conteúdo de um arquivo)","lib/LoopReadFile.htm"],
      ["Loop (registro)","lib/LoopReg.htm"]
    ]],
  ...
  [
    ...
    ["Controle ListView da Gui","lib/ListView.htm"],
    ["Controle TreeView da Gui","lib/TreeView.htm"],
    ["IfMsgBox","lib/IfMsgBox.htm"],
  ...
  ["Operações Matemáticas","lib/Math.htm",
  [
  ...
  ["Tipos de Objetos","",
  [
    ["Objeto","lib/Object.htm"],
    ["Enumerador","lib/Enumerator.htm"],
    ["Exceção","lib/Throw.htm#Exception"],
    ["Arquivo","lib/File.htm"],
    ["Func","lib/Func.htm"],
    ["Objetos de Função","misc/Functor.htm"],
    ["InputHook Object","lib/InputHook.htm#object"],
    ["RegExMatch","lib/RegExMatch.htm#MatchObject"]
  ]],
  ["Processos","",
  [
